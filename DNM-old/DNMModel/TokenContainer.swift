...
public class TokenContainer: Token {
    ...
    */
    public init(identifier: String, openingValue: String = "", startIndex: Int = 0) {
    ...
    */
    ...
    public func hasTokenWith(identifier: String) -> Bool {
        for token in tokens { if token.identifier == identifier { return true } }
        return false
    }
