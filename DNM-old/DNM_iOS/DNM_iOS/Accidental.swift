...
// TODO: Break out to individual files, rename
public class Accidental: CALayer, Guido, BuildPattern {
    ...
    public var color: CGColor = DNMColor.grayscaleColorWithDepthOfField(.Foreground).CGColor {
    ...
    ) -> Accidental?
    {
        ...
        if accidental != nil {
            ...
            accidental!.s = s
            accidental!.build()
            accidental!.color = DNMColor.grayscaleColorWithDepthOfField(.MostForeground).CGColor
            return accidental!
        }
        return nil
    }
