...
public class MeasureNumber: ViewNode, BuildPattern {
    ...
    private func addNumberLayer() {
        ...
        numberLayer.foregroundColor = DNMColor.grayscaleColorWithDepthOfField(.Foreground).CGColor
    ...
    private func addBorderLayer() {
        ...
        borderLayer.strokeColor = DNMColor.grayscaleColorWithDepthOfField(.Middleground).CGColor
