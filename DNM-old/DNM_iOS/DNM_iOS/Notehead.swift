...
public class Notehead: CALayer, StaffItem {
    ...
    public func setVisualAttributes() {
        ...
        shapeLayer.fillColor = DNMColor.grayscaleColorWithDepthOfField(.Middleground).CGColor
...
public class NoteheadDiamondEmpty: Notehead {
    ...
    public override func setVisualAttributes() {
        ...
        shapeLayer.strokeColor = DNMColor.grayscaleColorWithDepthOfField(.Middleground).CGColor
