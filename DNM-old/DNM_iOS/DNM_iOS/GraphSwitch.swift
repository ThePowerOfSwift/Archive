...
/*
public class GraphSwitch: GraphLayer {
    ...
    */
    ...
    public override func build() {
        ...
        shape.fillColor = DNMColor.grayscaleColorWithDepthOfField(.Middleground).CGColor
        shape.strokeColor = DNMColor.grayscaleColorWithDepthOfField(.Middleground).CGColor
        shape.lineWidth = 2
        addSublayer(shape)
    }
}
