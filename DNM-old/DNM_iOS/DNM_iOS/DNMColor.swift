...
public class DNMColor {
    
    class func grayscaleColorWithDepthOfField(depthOfField: DepthOfField,
    ...
    class func grayscaleColorWithDepthOfField(depthOfField: DepthOfField) -> UIColor {
    ...
    class func colorWithHue(hue: CGFloat, andDepthOfField depthOfField: DepthOfField
        ) -> UIColor
    {
    ...
    class func colorWithHue(hue: CGFloat,
        andDepthOfField depthOfField: DepthOfField,
        inColorMode colorMode: ColorMode
        ) -> UIColor
    {
        let (s, b) = getSaturationAndBrightnessWithDepthOfField(depthOfField,
