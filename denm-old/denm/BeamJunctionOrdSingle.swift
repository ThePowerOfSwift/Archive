...
/**
BeamJunctionOrdSingle: more discussion needed
*/
class BeamJunctionOrdSingle: BeamJunction {
    
    // MARK: Create a BeamJunctionOrdSingle
    
    /**
    Create a BeamJunctionOrdSingle with level of Subdivision of current Duration
